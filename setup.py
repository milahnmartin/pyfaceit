...
LONG_DESCRIPTION = """Popular Online Gaming Platform allows games like counterstrike and much more to be played on their servers,
                Faceit has created a pretty interesting and hard to understand API that can extract player and game data, this package will do all the hard backend stuf for you so you can just simply import the package and query
...
setup(
    ...
    keywords=["python", "faceit", "api",
              "rest api", "get data", "flask", "python"],
    classifiers=[
